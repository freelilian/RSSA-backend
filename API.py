...
def controversial_items(full_path_MFmodel, full_path_offline_prediction, ratings_newUser, 
                            newUserID, distance_choice, num_neighbors):
    start = time.time()
...
if __name__ == '__main__':
    ...
    recommendation_topn = topn_items(full_path_MFmodel, ratings_newUser, newUserID, numRec)
    list_name = "Traditional TopN"
    attributes_to_print = ['item', 'prediction']
    print_to_screen(recommendation_topn, newUserID, list_name, attributes_to_print, "%20.0f%20.2f")

    
    #===> testing - Things we think you will hate
    offline_item_ave_full_path = "./offline_prediction_testing/items_prediction_ave.npz"
    attri_name = ['item', 'ave']    
    recommendation_hateitems = hate_items(full_path_MFmodel, ratings_newUser, newUserID, 
                                            offline_item_ave_full_path, attri_name, numRec)
    ...
    print_to_screen(recommendation_hateitems, newUserID, list_name, attributes_to_print, "%20.0f%20.2f%20.2f%20.2f")
    ...
    recommendation_hipitems = novel_items(full_path_MFmodel,ratings_newUser, newUserID, 
    ...
    print_to_screen(recommendation_hipitems, newUserID, list_name, attributes_to_print, "%20.0f%20.2f%20.0f")
    ...
    recommendation_highStd = high_std_items(full_path_MFmodel, path_resampled_model, ratings_newUser, newUserID, numRec)
    list_name = "Things we have no clue about: "
    attributes_to_print = ['item', 'prediction', 'std']
    print_to_screen(recommendation_highStd, newUserID, list_name, attributes_to_print, "%20.0f%20.2f%20.2f")
    ...
    num_neighbors = 20
    recommendation_controversial = controversial_items(full_path_MFmodel, full_path_offline_prediction, 
    ...
    print_to_screen(recommendation_controversial, newUserID, list_name, attributes_to_print, "%20.0f%20.2f%20.2f")
